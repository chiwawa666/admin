<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="火化时间" align="center">
        <template slot-scope="{ row }">
          <span>{{ row.fireTime }}</span>
        </template>
      </el-table-column>
...
<script>
import { getBuryWarning, modifyStatus } from "@/api/warn";
...
export default {
  ...
  methods: {
    getList() {
      ...
      getBuryWarning(this.listQuery).then((response) => {
