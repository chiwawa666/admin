<template>
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        <el-form-item label="车牌号">
          <el-input v-model="temp.carName" placeholder="请输入" />
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="车辆资源详情" :visible.sync="dialogInfoVisible">
      <el-form
        ref="dataForm"
        :rules="rules"
        :model="temp"
...
<script>
import { getCars, getCarInfo, updateCars, deleteCar } from "@/api/funeral";
  ...
  methods: {
    ...
    createData() {
      this.$refs["dataForm"].validate((valid) => {
        if (valid) {
          updateCars(this.temp, "post").then(() => {
            this.$message({
              message: "操作成功！",
              type: "success",
            });
    ...
    updateData() {
      this.$refs["dataForm"].validate((valid) => {
        if (valid) {
          ...
          const { carid, parlorid, carName } = tempData;
          console.log(carid, parlorid, carName);
          updateCars({ carid, parlorid, carName }, "put").then(() => {
            this.dialogFormVisible = false;
            this.$message({
              message: "操作成功！",
              type: "success",
